...
**한 사람에 한 조서, 들어온 순서대로.** 아무도 아직 안 건드린 조서를 앞에서부터 준다.
...
그런 조서가 하나도 없을 때만 **이미 한 자리 찬 조서를 두 사람째** 내준다.
둘이 동시에 접속했는데 대기열에 갑 하나뿐인 경우가 그렇다 — 뒷사람을 지어낸 조서로
보내느니 갑을 한 번 더 읽힌다. 한 조서에 두 사람까지고, 그때는 판결도 통지도 두 번이다.
